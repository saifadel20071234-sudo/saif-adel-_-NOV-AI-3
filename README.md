...
## 🌟 أحدث المميزات المضافة (New Features)
- **مؤشر حماية البيئة (CO2 Tracker):** يحسب مقدار غاز ثاني أكسيد الكربون (CO2) الذي تم منع انبعاثه بفضل توليد الطاقة النظيفة.
- **تصدير التقارير (CSV Export):** زر لتحميل جميع البيانات التاريخية في ملف Excel بضغطة واحدة.
- **صفحة تحليلات تاريخية (Analytics):** صفحة جديدة تعرض ملخص الأيام السابقة وتاريخ الطاقة والبطارية والإشغال.
- **توثيق واجهة البرمجة (API Docs):** صفحة Swagger تفاعلية مدمجة للـ Backend يمكن الوصول إليها عبر رابط (توثيق المبرمجين) في لوحة التحكم.
- **إشعارات البريد الإلكتروني (Email Alerts):** إرسال إنذار فوري على البريد الإلكتروني عند اكتشاف أي أعطال أو شذوذ بواسطة الذكاء الاصطناعي.
